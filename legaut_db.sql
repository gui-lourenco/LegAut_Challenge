...
--
-- Host: localhost    Database: legaut_db
-- ------------------------------------------------------
...
CREATE TABLE `contrato` (
  `numero_contrato` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `cpf` varchar(11) NOT NULL,
  `arquivo` varchar(100) NOT NULL,
  PRIMARY KEY (`numero_contrato`),
  KEY `cpf` (`cpf`),
  CONSTRAINT `contrato_ibfk_1` FOREIGN KEY (`cpf`) REFERENCES `cliente` (`cpf`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
